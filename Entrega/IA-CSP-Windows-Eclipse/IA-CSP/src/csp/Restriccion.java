...
public class Restriccion {
	...
	public void propagar(Object v){
		...
		this.variable.intersecarDominios(aux_dom);
	}
	...
	/*public Vector inconsistente(Object v){
		...
		for(int i = 0; i < this.valor.length; i++){
			// Ademas de existir la restriccion, debe ser un valor válido
			if(valor[i].getValor1().equals(v) && this.variable.getDominio().contains(valor[i].getValor2())){
				aux_dom.add(valor[i].getValor2());
			}
		}
		return aux_dom;
	...
	public boolean inconsistente(Object v){
		//Vector aux_dom = new Vector();
